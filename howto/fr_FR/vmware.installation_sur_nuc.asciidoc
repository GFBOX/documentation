...
Pour la suite voici un https://github.com/jeedom/documentation/blob/master/howto/fr_FR/vmware.creer_une_vm.asciidoc[tutoriel] pour la création de votre première VM. Et vous trouverez https://github.com/jeedom/documentation/blob/master/howto/fr_FR/vmware.trucs_et_astuces.asciidoc[ici] un tutoriel de trucs et astuces (pour par exemple mettre votre licence VMware)
